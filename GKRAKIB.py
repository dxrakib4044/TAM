...
class jalan:
    def __init__(self, z):
        for e in z + "\n":
            ...
            sys.stdout.flush()
            time.sleep(0.001)
sys.stdout.write('\x1b[1;35m\x1b]2; RAKIB X KING \x07')
...
\x1b[38;5;46m______________________________________________________
 \033[1;31m[\033[1;32m[H]\033[1;31m]\033[1;32m DEVELOPER : DX RAKIB KING.
 \033[1;31m[\033[1;32m[R]\033[1;31m]\033[1;32m DEVELOPER : BOSS RAKIB KING
 \033[1;31m[\033[1;32m[I]\033[1;31m]\033[1;32m FACEBOOK  : LX RAKIB BOSS
 \033[1;31m[\033[1;32m[D]\033[1;31m]\033[1;32m GITHUB    : DX-RAKIB -404
...
def Main():
	...
	if opt in ["B","2"]:
		admin()
	if opt in ["C","3"]:
		os.system('xdg-open https://www.facebook.com/profile.php?id=100095282897095');time.sleep(1)
		fb()
	if opt in ["D","4"]:
		os.system('xdg-open https://wa.me/+8801603238653');time.sleep(1)
		group()
	if opt in ["0","0"]:
		exit()
...
def admin():
	...
	if bal =='1':
		...
		admin()
	if bal =='2':
		os.system('xdg-openhttps://github.com/dxrakib4044?tab=repositories');time.sleep(1)
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/dxrakib4044?tab=repositories');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://github.com/dxrakib4044/trick/tree/main").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am RAKIB VAI er  BOSS and my boss is RAKIB.Sir this tool is paid because 100% ok id just now login\"")
